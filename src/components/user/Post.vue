<template>
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <input type="date" class="form-control" v-model="txtAvailableFromDate" id="txtAvailableFromDate" placeholder="Pick Available From Date" autocomplete="off"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button type="buttion" @click="savePost" class="btn btn-dark pull-right"><i class="fa fa-upload fa-lg"></i> Post This</button>
            </div>
        </div>
    </div>
    <br>
